...
Open **Mirror controls → Decoder challenges** in the relayed official ChatGPT interface. Choose **LoaF**, **PngSpeak**, **Original gptgif**, or **gptgif v4**, then generate a challenge. You can give GPT a format guide or let it investigate, and choose a UTF-8 note or random binary as the hidden payload. The v4 challenges randomize their alphabet and palette.
