...
- Unknown OpenAI-compatible histories cannot reconstruct a pre-existing ChatGPT tree. Mirror supplies that history as explicit context; histories generated through Mirror use stored prefix fingerprints to resume the real node.
